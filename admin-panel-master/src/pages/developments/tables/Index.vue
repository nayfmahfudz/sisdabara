...
export default {
  ...
  methods: {
    handleInput(value){
      if(!!value.target.value){
         axios.get(`http://192.168.10.102:8000/namapermohonan/`+value.target.value).then((response) => {
          this.items = response.data.data;
        });
      }else{
        axios.get(`http://192.168.10.102:8000/permohonan`).then((response) => {
  ...
  format_date(value){
    ...
    delet(e) {
      axios.delete(`http://192.168.10.102:8000/permohonan/` + e).then((response) => {
